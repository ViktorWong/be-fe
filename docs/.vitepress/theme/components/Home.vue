...
<template>
    ...
    <div class="section">
      <div class="features-small">
        <div class="feature">
          ...
          <p>
            Small startups, open source maintainers, and Fortune 500 enterprises
            all enjoy access to StackBlitz's committed product support, features
            and improvements.
          </p>
        </div>
        <div class="feature">
          ...
          <p>
            WebContainer API only requires the compute power of your local CPU
            and browser, eliminating the cost and overhead of managing remote
            servers.
          </p>
        </div>
        <div class="feature">
          <h2>Ship faster</h2>
          <p>
            No additional teams to build or maintain. Leave the technical
            support to us and focus on actually shipping your product.
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="section">
    <h2>
      ...
      <strong
        >we use<br />
        in our own products.</strong
      >
    </h2>
    <p>
      Years of development by our full-time engineering team, front-line
      feedback from leading community partners, and funded R&amp;D into future
...
.top-section {
  ...
  :root.dark & {
    background-image: url("/img/home-bg-dark.jpg");
  }
